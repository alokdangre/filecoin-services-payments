...
def analyze_codebase():
    ...
    key_files = ['foundry.toml', 'Makefile', 'README.md']
...
def generate_code_with_claude(task_description, codebase_context):
    ...
    prompt = f"""
You are an expert Solidity developer working on a Foundry-based smart contract project for payment systems.
...
- Use Solidity 0.8.30 (as specified in foundry.toml)
- Follow established patterns from the existing codebase
- Maintain consistency with existing code style and architecture
- Include proper error handling with custom errors
- Add comprehensive unit tests using Forge test framework
- Use OpenZeppelin contracts where appropriate (already available in lib/)
- Follow gas optimization best practices
- Include proper NatSpec documentation
